...
df = pd.read_csv('E:/Área de trabalho/Códigos/R/rs_dados_justica_audienciadecustodia/data/POVOAMENTO.csv', sep = ';')
...
for i in range(0,len(df)):
    ...
    code = list(pd.read_csv('E:/Área de trabalho/Códigos/R/rs_dados_justica_audienciadecustodia/data/'+codigol1[i],sep=';', encoding= 'latin-1'))
